export const NEXT_HOPS_NOTE =
    ...
    'Waypoints are open Virgin ground (`isVirgin` — no completed reveal, minted or not, so nobody controls it ' +
    'and it charges nothing), your own cells, and any cell with a finished Hub; only foreign land past its ' +
    'first reveal without a finished Hub is closed. A Hub ' +
