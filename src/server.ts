...
import { registerEvictLotTool } from './tools/trade/evict-lot/evict-lot.js';
...
import { registerGetLotTermsTool } from './tools/trade/lot-terms/lot-terms.js';
...
import { registerQuoteLotReturnTool } from './tools/trade/quote-lot-return/quote-lot-return.js';
import { registerReturnLotTool } from './tools/trade/return-lot/return-lot.js';
...
function registerTools(registrar: ToolRegistrar, context: AppContext, persona: PersonaDelivery): void {
    ...
    registerGetLotTermsTool(registrar, context);
    registerCreateLotTool(registrar, context);
    registerBuyLotTool(registrar, context);
    registerEvictLotTool(registrar, context);
