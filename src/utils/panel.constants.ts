...
export const PANEL_COLON_SUBSTITUTE = ';';
...
export const PANEL_CHARACTER_SUBSTITUTES: ReadonlyMap<string, string> = new Map([
    [PANEL_BAR, PANEL_BAR_SUBSTITUTE],
    [PANEL_COLON, PANEL_COLON_SUBSTITUTE],
]);
