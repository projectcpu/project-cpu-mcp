export const CELL_ABI = [
        ...
        outputs: [
            {
                ...
                components: [
                    ...
                    { name: 'processDrawPerCycle', type: 'uint64', internalType: 'uint64' },
                ],
            },
        ],
        stateMutability: 'view',
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'requestId', type: 'uint64', indexed: false, internalType: 'uint64' },
            { name: 'isGenesis', type: 'bool', indexed: false, internalType: 'bool' },
            { name: 'revealCount', type: 'uint32', indexed: false, internalType: 'uint32' },
            { name: 'requestedAt', type: 'uint64', indexed: false, internalType: 'uint64' },
        ],
        anonymous: false,
    },
    {
        type: 'event',
        name: 'RevealFulfilled',
        inputs: [
            { name: 'tokenId', type: 'uint256', indexed: true, internalType: 'uint256' },
            { name: 'source', type: 'address', indexed: true, internalType: 'address' },
            { name: 'requestId', type: 'uint64', indexed: false, internalType: 'uint64' },
            { name: 'revealCount', type: 'uint32', indexed: false, internalType: 'uint32' },
            { name: 'resources', type: 'uint16[3]', indexed: false, internalType: 'uint16[3]' },
            { name: 'amounts', type: 'uint64[3]', indexed: false, internalType: 'uint64[3]' },
            { name: 'strengths', type: 'uint8[3]', indexed: false, internalType: 'uint8[3]' },
        ],
        anonymous: false,
    },
    {
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'drawPerCycle', type: 'uint64', indexed: false, internalType: 'uint64' },
        ],
        anonymous: false,
    },
    {
        ...
        inputs: [
            ...
            { name: 'claimedAt', type: 'uint64', indexed: false, internalType: 'uint64' },
        ],
        anonymous: false,
    },
    {
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'withdrawnAt', type: 'uint64', indexed: false, internalType: 'uint64' },
        ],
        anonymous: false,
    },
    {
    ...
    {
        type: 'error',
        name: 'RevealNotConfigured',
        inputs: [],
    },
    {
        type: 'error',
        name: 'RevealCellOccupied',
        inputs: [],
    },
    {
        type: 'error',
        name: 'RevealProcessActive',
        inputs: [],
    },
    {
        type: 'error',
        name: 'RevealAlreadyPending',
        inputs: [],
    },
    {
        type: 'error',
