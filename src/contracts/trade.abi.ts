        ...
        outputs: [
            {
                name: 'quote',
                type: 'tuple',
                internalType: 'struct ITrade.SaleQuote',
                components: [
                    { name: 'buyerTotal', type: 'uint256', internalType: 'uint256' },
                    { name: 'sellerNet', type: 'uint256', internalType: 'uint256' },
                    { name: 'sale', type: 'uint256', internalType: 'uint256' },
                    { name: 'feeBp', type: 'uint16', internalType: 'uint16' },
                    { name: 'hubFee', type: 'uint256', internalType: 'uint256' },
                    { name: 'burn', type: 'uint256', internalType: 'uint256' },
                    { name: 'discount', type: 'uint256', internalType: 'uint256' },
                    { name: 'tax', type: 'uint256', internalType: 'uint256' },
                    { name: 'ownerNet', type: 'uint256', internalType: 'uint256' },
                    { name: 'buyerSyndicateId', type: 'uint256', internalType: 'uint256' },
                    { name: 'ownerSyndicateId', type: 'uint256', internalType: 'uint256' },
                    { name: 'taxTo', type: 'address', internalType: 'address' },
                ],
            },
        ],
        stateMutability: 'view',
        ...
        outputs: [
            {
                name: 'quote',
                type: 'tuple',
                internalType: 'struct ITrade.BuyQuote',
                components: [
                    {
                        name: 'sale',
                        type: 'tuple',
