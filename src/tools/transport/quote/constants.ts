export const QUOTE_TRANSPORT_DESCRIPTION = [
    ...
    'endpoints that are not your own cells past their first completed reveal, or a destination with no room once',
    'liquid, reserved and pending production are counted. A successful quote validates route mechanics and',
    'economics at quote time, destination capacity included; it reserves no room and does not promise the later',
    '`cpu_transport` will succeed — ownership, balances, capacity, pauses, allowances and live state can still',
    'change before the send. Plan the chain with',
