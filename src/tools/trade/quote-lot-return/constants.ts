export const QUOTE_LOT_RETURN_DESCRIPTION = [
    ...
    'and whether the destination can still take the whole remainder right now. The fee it names is the exact',
    'ceiling `cpu_return_lot` carries, so run this immediately before the return.',
].join(' ');
