export const GET_MARKETS_DESCRIPTION = [
    ...
    'specific lots with `cpu_list_lots`. Every bucket here counts offers — open, incoming or frozen; an evicted',
    'lot is not for sale and is in none of them. Public read; supports hub / resourceId filters and an optional zone',
