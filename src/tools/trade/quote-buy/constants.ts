export const QUOTE_BUY_DESCRIPTION = [
    ...
    'sale-fee-tolerance freeze, a hub on the route that cannot serve as a live node right now — temporarily',
    'unroutable, not frozen). It does NOT check pause, $CPU balance, or',
