...
- **Funding** — use `references/funding.md` when the goal needs ETH, $CPU, or wCPU.
- **Production** — use `references/production.md` for reveal, buildings, mining, or crafting.
- **Logistics** — use `references/logistics.md` for route discovery, transport, delivery, and warehouse capacity.
